...
@section('top-actions')
    <a href="{{ route('admin.production') }}" class="btn btn-ghost">← Volver a Producción</a>
@endsection
...
<div class="panel">
    ...
    <div class="panel-body">
        <form method="POST" action="{{ route('admin.production-store') }}" id="production-form">
            @csrf
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select name="supervised_by" class="form-select">
                        <option value="">-- Ninguno --</option>
                        @foreach($supervisors ?? [] as $sup)
                        <option value="{{ $sup->id }}" {{ old('supervised_by') == $sup->id ? 'selected' : '' }}>{{ $sup->name }} {{ $sup->lastname }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
